    ...
    if request.user.is_authenticated():
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                # email_text = 'User: "' + str(username) + '" submitted his/her feedback on BDO Platform, regarding action: "' + str(action) + '".\nComment: "' + str(details) + '"\nRating: ' + str(rating) + '/5 stars.'
                # send_mail(str(username) + "'s Feedback on BDO Platform", email_text, 'sender@hotmail.com', ['reveiver@gmail.com'], fail_silently=False)
                # print email_text
