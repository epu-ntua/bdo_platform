...
def get_live_ais(request):
    try:
        ...
        legend_id = ""
        query_pk, df, notebook_id = get_data_parameters(request, '')
        cached_file, variable, vessel_column, vessel_id, color_col, marker_limit, use_color_column, agg_function, lat_col, lon_col, time_col, var_unit = get_markers_parameters(request, '', 'live_ais')
