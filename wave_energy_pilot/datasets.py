...
DATASETS = (
    ...
    #      applications=["data_visualisation"]),
    dict(id="111", title="Maretec Wave Forecast", variables=(dict(id=1, title="Sea surface wave zero upcrossing period", name="sea_surface_wave_zero_upcrossing_period"),
