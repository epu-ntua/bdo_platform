...
DATASETS = (
    ...
    dict(id="2345", title="Maritec - 1", variables=(dict(id=1, title="wave_period"),
         ...
         applications=["wave_resource_assessment_single"]),
    dict(id="3456", title="Dummy Name", variables=(dict(id=1, title="wave_period"),
         ...
         applications=["wave_resource_assessment_area"]),
    ...
    dict(id="14", title="Maretec Wave Forecast", variables=(dict(id=1, title="sea_surface_wave_zero_upcrossing_period"),
                     ...
                     min_lat=-90.00, max_lat=90.00, min_lng=-180.00, max_lng=180.00, min_date="12/01/2018", max_date="02/02/2019",
             applications=["data_visualisation", "wave_forecast", "wave_resource_assessment_single", "wave_resource_assessment_area"])
)